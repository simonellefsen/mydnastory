...
export const messages: Record<Locale, Messages> = {
  en: {
    meta: {
      ...
      siteOg: "First names. Whole genomes. A growing archive.",
    ...
    notes: {
      ...
      footer: (name) => `myDNAStory · ${name} · data from FamilyTreeDNA, retold for the screen.`,
    },
    kinshipBanner: {
  ...
  da: {
    meta: {
      siteTitle: "myDNAStory",
      siteDescription:
        "Et arkiv af DNA-historier fortalt med fornavn: autosomale rødder, oldtidens Europa, maternelle haplogrupper og kromosom-silhuetter.",
      siteOg: "Fornavne. Hele genomer. Et voksende arkiv.",
    ...
    notes: {
      ...
      footer: (name) => `myDNAStory · ${name} · data fra FamilyTreeDNA, genfortalt til skærmen.`,
    },
    kinshipBanner: {
